# Build Guide for Alibaba Cloud Credentials C++

This document provides detailed instructions for building the Alibaba Cloud Credentials C++ library from source.
...
| `ENABLE_RTTI` | ON | Enable Run-Time Type Information | `-DENABLE_RTTI=OFF` |
| `MINIMIZE_SIZE` | OFF | Minimize binary size (may affect performance) | `-DMINIMIZE_SIZE=ON` |
